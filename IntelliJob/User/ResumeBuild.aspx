                    ...
                    <div class="form-contact contact_form">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtTenth" runat="server" CssClass="form-control" placeholder="Example: 90% ">
                                </asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtTwelfth" runat="server" CssClass="form-control" placeholder="Example: 90% ">
                                </asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Graduation with CGPA</label>
                                <asp:TextBox ID="txtGraduation" runat="server" CssClass="form-control" placeholder="Example: BSCS with 3.37cgpa">
                                </asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Post Graduation with CGPA</label>
                                <asp:TextBox ID="txtPostGraduation" runat="server" CssClass="form-control" placeholder="Example: MSCS with 3.87cgpa">
                                </asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtExperience" runat="server" CssClass="form-control" placeholder="Experience">
                                </asp:TextBox>
                            </div>
                        </div>
