<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="IntelliJob.User.Login" %>
                    ...
                    <div class="form-contact contact_form">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <span class="clickLink">
                                <a href="../User/Register.aspx">New User? Click Here..
                                </a>
                            </span>
                        </div>
                    </div>
