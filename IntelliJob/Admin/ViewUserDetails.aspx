<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ViewUserDetails.aspx.cs" Inherits="IntelliJob.Admin.ViewUserDetails" %>
    ...
    <div style="background-image: url('../Images/bg.jpg'); width: 100%; height: 720px; background-repeat: no-repeat; background-size: cover; background-attachment: fixed;">
        <div class="container pt-4 pb-4">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                ...
                <asp:Panel ID="pnlName" runat="server" CssClass="col-md-6 pt-3">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                ...
                <asp:Panel ID="pnlMobile" runat="server" CssClass="col-md-6 pt-3">
            ...
            <asp:Panel ID="pnlCompanyFields" runat="server" Visible="false">
                <h4 class="text-center mt-4 mb-3">Company Information</h4>

                <div class="row mr-lg-5 ml-lg-5 mb-3">
                    <div class="col-md-6 pt-3">
                        <label for="lblCompanyName" style="font-weight: 600">Company Name</label>
                        <asp:Label ID="lblCompanyName" runat="server" CssClass="form-control" style="background-color: #f8f9fa; border: 1px solid #dee2e6;"></asp:Label>
                    </div>
                    <div class="col-md-6 pt-3">
                ...
                <div class="row mr-lg-5 ml-lg-5 mb-3">
                    <div class="col-md-6 pt-3">
                        <label for="lblCompanySize" style="font-weight: 600">Company Size (Number of Employees)</label>
                        <asp:Label ID="lblCompanySize" runat="server" CssClass="form-control" style="background-color: #f8f9fa; border: 1px solid #dee2e6;"></asp:Label>
                    </div>
                </div>
            </asp:Panel>
