<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true"
    CodeBehind="JobList.aspx.cs" Inherits="IntelliJob.Admin.JobList" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div
            style="background-image: url('../Images/bg.jpg'); width: 100%; height: 720px; background-repeat: no-repeat; background-size: cover; background-attachment: fixed;">
            <div class="container-fluid pt-4 pb-4">
                ...
                <div id="pnlToolbar" class="btn-toolbar justify-content-between" style="margin-bottom: 0;">
                    ...
                    <div class="input-group h-25">
                        <asp:HyperLink ID="linkBack" runat="server" NavigateUrl="~/Admin/ViewResume.aspx"
                ...
                <div class="row mb-3 pt-sm-3">
                    <div class="col-md-12">
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered"
                            HeaderStyle-HorizontalAlign="Center" EmptyDataText="No Record to Display..!"
                            AllowPaging="True" PageSize="5" OnPageIndexChanging="GridView1_PageIndexChanging"
                            DataKeyNames="JobId" OnRowDeleting="GridView1_RowDeleting" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="View">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="lnkViewJob" runat="server"
                                            NavigateUrl='<%# GetViewJobUrl(Eval("JobId").ToString()) %>'>
                                            <asp:Image ID="Img" runat="server" ImageUrl="../assets/img/icon/view.png"
