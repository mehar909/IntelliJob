<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="UserList.aspx.cs" Inherits="IntelliJob.Admin.UserList" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" HeaderStyle-HorizontalAlign="Center"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="View">
                                <ItemTemplate>
                                    <asp:HyperLink ID="lnkViewUser" runat="server" NavigateUrl='<%# "ViewUserDetails.aspx?id=" + Eval("UserId") + "&returnUrl=UserList.aspx" %>'>
